...
def assess_model(name,
    ...
    try:
        ...
        #with open('data/gs_rf_' + genre + '.txt', 'a') as statfile:
        #    statfile.write(str(gr.cv_results_))
...
def assess_genre(genre):
    assess_model('RandomForest Fscore',
                 RandomForestClassifier(),
                 {"max_depth": [3, 4, 5, None],
                  'random_state': [1729,],
                  'class_weight': ['balanced',],
                  'max_features': [1, 3, 5, 8, 13, 21,],
                  ...
                  "n_estimators": [40, 80, 120, 200, 300,]},
                 genre,
